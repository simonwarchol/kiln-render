...
const origin = (
  process.env.SITE_ORIGIN || (base === "/" ? "https://kilnrender.com" : "")
).replace(/\/$/, "");
...
export default defineConfig({
  ...
  head: [
    ...
    ...(isPreview
      ? [
          ["meta", { name: "robots", content: "noindex, nofollow" }] as [
            string,
    ...
    ...(siteUrl
      ? ([
          ...
          [
            "meta",
            { property: "og:image", content: `${siteUrl}kiln_social.jpg` },
          ],
          [
            "meta",
            { name: "twitter:image", content: `${siteUrl}kiln_social.jpg` },
          ],
    ...
    [
      "script",
      {
        "data-goatcounter": "https://mpanknin.goatcounter.com/count",
        async: "",
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Virtual texturing",
            link: "/architecture/virtual-texturing",
          },
