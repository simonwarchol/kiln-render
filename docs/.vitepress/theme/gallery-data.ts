...
// Demo hrefs are site-root paths (`/app/?…`). Gallery.vue runs them through
// withBase() so they stay on whatever host+prefix this deploy uses (apex,
// github.io/<repo>/, or preview/). Don't hardcode kilnrender.com / github.io.
//
